  ...
  return (
    <div className="min-h-screen bg-[var(--nc-ink)] text-slate-200">
      ...
      <section className="relative isolate min-h-[100svh] overflow-hidden">
        ...
        <div
          aria-hidden
          className="absolute inset-0 bg-[linear-gradient(180deg,transparent_55%,#020617_92%)]"
        />
        ...
        <div className="relative z-10 mx-auto flex min-h-[calc(100svh-5.5rem)] w-full max-w-6xl flex-col justify-end px-6 pb-20 pt-16 sm:pb-28">
          <div className="nc-fade-up mb-8">
            <Logo className="h-16 w-16 sm:h-20 sm:w-20" />
          </div>
          <p className="nc-fade-up nc-fade-up-delay-1 font-[family-name:var(--font-display)] text-5xl font-extrabold leading-[0.95] tracking-tight text-white sm:text-7xl md:text-8xl">
            NewsCrawl
          </p>
          <h1 className="nc-fade-up nc-fade-up-delay-2 mt-6 max-w-3xl font-[family-name:var(--font-display)] text-2xl font-semibold leading-snug text-slate-100 sm:text-4xl">
            Multilingual news intelligence for teams who need the story before it cools.
          </h1>
          <p className="nc-fade-up nc-fade-up-delay-3 mt-5 max-w-xl text-base leading-relaxed text-slate-400 sm:text-lg">
          ...
          <div className="nc-fade-up nc-fade-up-delay-3 mt-10 flex flex-wrap items-center gap-4">
            ...
            <Link
              href={primaryHref}
              className="rounded-lg border border-slate-700 px-6 py-3 text-sm font-medium text-slate-200 transition hover:border-slate-500 hover:text-white"
            >
              {primaryLabel}
            </Link>
          </div>
      ...
      {/* ── Capabilities ─────────────────────────────────────────────────── */}
      <section id="capabilities" className="border-t border-slate-900">
        <div className="mx-auto max-w-6xl px-6 py-24">
          <p className="text-sm font-medium uppercase tracking-[0.2em] text-sky-400">
            Capabilities
          </p>
          <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-display)] text-3xl font-bold text-white sm:text-4xl">
          ...
          <div className="mt-16 divide-y divide-slate-800 border-y border-slate-800">
      ...
      {/* ── Pipeline ─────────────────────────────────────────────────────── */}
      <section className="border-t border-slate-900 bg-[var(--nc-panel)]">
        <div className="mx-auto max-w-6xl px-6 py-24">
          <p className="text-sm font-medium uppercase tracking-[0.2em] text-sky-400">
            Pipeline
          </p>
